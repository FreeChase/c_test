...
#define XFSBL_STAGE3_0_A	(0x4U)	//* load bit
#define XFSBL_STAGE3_0_B	(0x5U)	//* load app

#define XFSBL_STAGE3_1		(0x6U)
#define XFSBL_STAGE3_2		(0x7U)
#define XFSBL_STAGE4		(0x10U)
#define XFSBL_STAGE_ERR		(0x11U)
#define XFSBL_STAGE_DEFAULT	(0x12U)
